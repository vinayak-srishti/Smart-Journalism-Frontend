      ...
      <div class="container py-5 h-100">
        <div class="row d-flex align-items-center justify-content-center h-100">
          ...
          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                            <h3 class="display-4" className='log1'> Journalist Login </h3>
                            <br></br>
       ...
       <br></br>
            <div class="text-center">
                  <button class="btn btn-primary" className='buttonn' type="submit">Submit</button>
                         ...
                         <br></br>
                         <br></br>
                                <div class="text-center "><p style={{color:'blue'}}>Don't  have an account?<a href="./Registerpage" class="font-italic text-muted" > 
